...
CONSTRAINT `fk_brands_id` FOREIGN KEY (brand_id) REFERENCES brands(id),
...
SELECT left(description, 15), reverse(p.name), date('2010-10-10'), p.price/8
FROM products AS p
WHERE p.id >= 5;
